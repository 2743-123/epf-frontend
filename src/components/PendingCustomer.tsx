...
const PendingCustomer: React.FC = () => {
  ...
  // =========================================================
  useEffect(() => {
    // First time page open hone par API call
    fetchData(true);

    // Har 5 minute me API call
    const interval = setInterval(() => {
      console.log("Auto refreshing pending customer data...");

      // Background refresh - loading screen nahi dikhegi
      fetchData(false);
    }, 5 * 60 * 1000);

    // Component unmount hone par interval clear
    return () => {
      ...
      >
        ...
        >
          <Box>
            ...
            >
              Click on <strong>any cell value</strong> (Name, UAN,
              Aadhaar, Mobile, Bank, IFSC, etc.) to copy it instantly.
            </Typography>
          </Box>
              ...
              {filteredData.length > 0 ? (
                filteredData.map((cust) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>
                        <Tooltip
                          title="Click to copy Aadhar Number"
                          arrow
                        >
                          <Box
                            component="span"
                      ...
                      <TableCell>
                        <Tooltip
                          title="Click to copy Aadhar Name"
                          arrow
                        >
                          <Box
                            component="span"
                      ...
                      <TableCell>
                        <Tooltip
                          title="Click to copy Account No."
                          arrow
                        >
                          <Box
                            component="span"
                      ...
                      <TableCell sx={{ color: "text.secondary" }}>
                        {cust.commissionAmount != null
                          ? `₹${cust.commissionAmount.toLocaleString()}`
                          : "—"}
                      </TableCell>
                      ...
                      <TableCell align="right" sx={{ pr: 3 }}>
                        <Tooltip
                          title="Review and confirm customer workflow"
                          arrow
                        >
                          <Button
                            variant="contained"
                ...
                <TableRow>
                  ...
                  >
                    ...
                    >
                      No pending customers found matching your
                      criteria.
                    </Typography>
                  </TableCell>
                </TableRow>
